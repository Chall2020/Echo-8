...
def main(target_file):
    ...
    while i < len(instructions):
        ...
        print(f"║                                                ║")
        print(f"║                                                ║")
        print(f"║ Current Instruction:    0x{instructions[i]}                  ║")
        print(f"╚════════════════════════════════════════════════╝")
...
while True:
	os.system(clear_string)
	print("Echo-8 Emulator.")
	print("Type 'assemble' to assemble code, or 'run' to run assembled code.")
	choice = input(">>> ").lower()
	...
	if args[0] == "assemble":
		os.system(clear_string)
		assemble.main(args[1], args[1][:-4]+".bin")
